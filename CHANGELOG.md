...
- Additional:
  ...
  - Fixes a bug when bolt mini cart button sometimes was not rendered in Fetch Cart flow under some conditions such as slow internet connection (race condition issue)
