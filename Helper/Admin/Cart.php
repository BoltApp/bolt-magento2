 ...
 */
namespace Bolt\Boltpay\Helper\Admin;
...
//        'reward',
     ...
     */
    public function getBoltpayAdminOrder($payment_only, $place_order_payload)
    {
        //Get cart data
        $cartData = $this->getAdminCartData($payment_only, $place_order_payload);
        if (!$cartData) {
            return;
        }
    ...
    public function getHints($place_order_payload)
    {
        ...
        // TODO: make it usable for Backend part.
        /** @var \Magento\Customer\Model\Customer $customer */
        $customer = $this->customer->load($quote->getCustomerId());
        if ($customer->getId()) {
     ...
     * @throws Exception
     */
    public function getAdminCartData($payment_only, $place_order_payload)
    {
