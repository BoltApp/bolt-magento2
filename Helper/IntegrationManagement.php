...
class IntegrationManagement extends AbstractHelper
{
    ...
    const BOLT_INTEGRATION_AUTHENTICATION_ENDPOINT_URL_SANDBOX = 'https://api-sandbox.boltapp.com/v1/magento2/bolt-checkout/authorize';
    const BOLT_INTEGRATION_IDENTITY_LINKING_URL_SANDBOX = 'https://status.boltapp.com/';
    const BOLT_INTEGRATION_TOKEN_EXCHANGE_URL_SANDBOX = 'https://api-sandbox.boltapp.com/v1/magento2/bolt-checkout/exchange';
    
    const BOLT_INTEGRATION_AUTHENTICATION_ENDPOINT_URL_PRODUCTION = 'https://api.boltapp.com/v1/magento2/bolt-checkout/authorize';
    const BOLT_INTEGRATION_IDENTITY_LINKING_URL_PRODUCTION = 'https://status.boltapp.com/';
    const BOLT_INTEGRATION_TOKEN_EXCHANGE_URL_PRODUCTION = 'https://api.boltapp.com/v1/magento2/bolt-checkout/exchange';
