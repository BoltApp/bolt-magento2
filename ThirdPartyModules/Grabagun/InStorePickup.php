...
class InStorePickup
{
     ...
     * @return bool
     */
    private function validateDistance(array $args)
    {
     ...
     * @return SearchCriteriaInterface
     */
    private function addBlockedFilter(SearchCriteriaInterface $searchCriteria)
    {
     ...
     * @return SearchCriteriaInterface
     */
    private function addExpiredFilter(SearchCriteriaInterface $searchCriteria)
    {
