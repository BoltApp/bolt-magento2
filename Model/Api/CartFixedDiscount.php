...
$txt = '$shippingAmount '.var_export($shippingAmount, true);
file_put_contents('/var/www/m7/vendor/boltpay/bolt-magento2/Model/Api/new1.txt', $txt.PHP_EOL , FILE_APPEND | LOCK_EX);
